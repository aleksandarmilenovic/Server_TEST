...
class GraphSolver(object):
	...
	def __init__(self, test):
		...
		print("NumNodes")
		for node in self.nodes:
			print(node.name + " " + str(len(node.childern)))
...
class Test(object):
	def __init__(self, task_namespace = 'A', num_of_tasks = 14, force_avg = 4, normal_avg = 10, num_of_depends = [2, 6, 4, 2], unit_test_case = False):
